  ...
  <div class="conatiner signUpPage vhContainer">
    ...
    <div>
      <form class="formControls" action="index.html">
        ...
        <input class="formControls_input" v-model="confirmPassword" type="password" name="pwd" id="pwd" placeholder="請再次輸入密碼" required>
        <input class="formControls_btnSubmit" @click="handleRegister" type="button" onclick="javascript:location.href='#todoListPage'" value="註冊帳號">
